...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for sentence in self.knowledge.copy():
            for sentence_2 in self.knowledge.copy():
                if sentence is sentence_2:
                    continue
                if sentence == sentence_2:
                    self.knowledge.remove(sentence_2)
                    continue
                if sentence.cells.issubset(sentence_2.cells):
                    difference = sentence_2.cells - sentence.cells
                    difference_count = sentence_2.count - sentence.count
    ...
    def make_safe_move(self):
        ...
        """
        valid_moves = self.safes - self.moves_made
        if valid_moves:
